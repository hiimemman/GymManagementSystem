<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MembershipStatus.aspx.cs" Inherits="batgymproject.MembershipStatus" %>
                                        ...
                                        <div class="col-lg-14">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                          <label for="TextPayment" class="col-sm-2 col-form-label">Enter Member ID: </label>
                                                        <div class="col-sm-4">
                                                            <asp:TextBox runat="server" ID="TextIDNumber" CssClass="form-control" placeholder="Enter Member ID"></asp:TextBox>
                                                        </div>
                                                        
                                       <div class="row mb-3">

                                        <label for="TextPayment" class="col-sm-2 col-form-label">Amount: </label>
                                      <div class="col-sm-4">
                                          <asp:TextBox runat="server" ID="TextPayment" CssClass="form-control" placeholder="Enter Amount Payment" />
                                                        ...
                                                        <asp:Button runat="server" Text="Refresh" ID="BtnRefresh" CssClass="btn btn-primary" Onclick="BtnRefresh_Click"/>
