<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logs.aspx.cs" Inherits="batgymproject.Logs" %>
              ...
              <div class="col-lg-14">
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <asp:GridView ID="GridView2" runat="server" CssClass="table table-hover table-bordered"></asp:GridView>
