<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="batgymproject.Dashboard" %>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item nav-link bi bi-grid">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <asp:LinkButton ID="LinkBtnViewAccount" runat="server" OnClick="LinkBtnViewAccount_Click">View Customers</asp:LinkButton>
                </li>  
                 <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Workouts</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
<asp:LinkButton ID="AddActivities" runat="server" OnClick ="AddActivities_Click">New Activity</asp:LinkButton>
          </li>
          <li>
