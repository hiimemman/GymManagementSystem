<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAccount.aspx.cs" Inherits="batgymproject.ViewAccount" %>
                                    ...
                                    <div class="row">
                                      ...
                                      <asp:RadioButton ID="RadioButtonFemale" runat="server" GroupName="RadioBtnSex" Text="Female" OnCheckedChanged="RadioButtonFemale_CheckedChanged" />
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="DropPackage" runat="server" class="dropdown-item d-flex align-items-center form-select">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <label for="TextIDNumber" class="col-sm-2 col-form-label">ID Number</label>

                                                        <div class="col-sm-4">
                                                            <asp:TextBox runat="server" ID="TextIDNumber" CssClass="form-control" placeholder="Enter ID Number for Update or Delete"></asp:TextBox>
                                                        </div>

                                                        <label for="TextContact" class="col-sm-2 col-form-label"></label>
                                                     ...
                                                     <div class="row mb-3">
                                                        ...
                                                        <label for="TextBoxSearch" class="col-sm-2 col-form-label">Search</label>

                                                        <div class="col-sm-4">
                                                            <asp:TextBox runat="server" ID="TextBoxSearch" CssClass="form-control" placeholder="Search...."></asp:TextBox>
                                                        </div>


                                                        <div class="col-md-4">
                                                            <asp:Button runat="server" Text="Search" ID="BtnSearch" CssClass="btn btn-primary" OnClick="BtnSearch_Click" />
                                                            <asp:Button runat="server" Text="Show All" ID="BtnShowAll" CssClass="btn btn-primary" Onclick="BtnShowAll_Click" />
